...
const $$CalendarioMesaEspiral = createComponent(
  async ($$result, $$props, $$slots) => {
    ...
    [
      {
        src: Img1.src,
        alt: 'Calendario de mesa personalizado con espiral para empresas en Barcelona, perfecto para regalos corporativos.',
      },
      {
        src: Img2.src,
        alt: 'Calendario publicitario de sobremesa personalizado con espiral, ideal para promoción de marca en oficinas.',
      },
      {
        src: Img3.src,
        alt: 'Calendarios personalizados de mesa con espiral, ideales para empresas, formato A4 con logotipo.',
      },
      {
        src: Img4.src,
        alt: 'Calendarios de sobremesa personalizados con espiral, diseño elegante para oficinas y empresas en Cataluña.',
      },
    ];
    const metadata = {
      title: 'Calendarios de Mesa Personalizados con Espiral | Regalos Corporativos Únicos',
      description:
        'Descubre nuestros calendarios de mesa personalizados, ideales para empresas y oficinas. Personaliza tu calendario sobremesa con espiral y destaca tu marca con un diseño atractivo y funcional. Impresión de alta calidad en Barcelona.',
      keywords: [
      ...
      jsonLd: {
        ...
        description:
          'Personaliza calendarios de mesa personalizados para empresas y oficinas. Perfectos para promocionar tu marca durante todo el año.',
        image: `${Img1.src}`,
        brand: {
          '@type': 'Brand',
          name: 'Repro Disseny',
