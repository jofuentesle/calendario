...
const $$Personal = createComponent(
  ($$result, $$props, $$slots) => {
    const metadata = {
    ...
    return renderTemplate`${renderComponent(
      ...
      { metadata: metadata },
      {
        announcement: ($$result2) =>
          renderTemplate`${renderComponent($$result2, 'Fragment', Fragment, { slot: 'announcement' })}`,
        default: ($$result2) =>
              ...
              content: ($$result3) =>
                renderTemplate`${renderComponent(
                  ...
                  { slot: 'content' },
                  {
                    default: (
                      $$result4
                    ) => renderTemplate` <h2 class="text-2xl font-bold tracking-tight dark:text-white sm:text-3xl mb-2">About me</h2> <p>
...
</p> <br> <p>If you're curious to dive deeper into my work, you can follow me:</p> `,
                  }
                )}`,
            }
              ...
              content: ($$result3) =>
                renderTemplate`${renderComponent(
                  ...
                  { slot: 'content' },
                  {
                    default: (
                      $$result4
                    ) => renderTemplate` <h3 class="text-2xl font-bold tracking-tight dark:text-white sm:text-3xl mb-2">
Project 1: <br><span class="text-2xl">Brand identity for tech innovators</span> </h3> `,
                  }
                )}`,
            }
          )}  ${renderComponent(
...
Project 2: <br><span class="text-2xl">Event poster for art & music festival</span> </h3> `,
                  }
                )}`,
            }
          )}  ${renderComponent(
...
Project 3: <br><span class="text-2xl">E-commerce website redesign for fashion brand</span> </h3> `,
                  }
                )}`,
            }
        ...
        header: ($$result2) =>
          renderTemplate`${renderComponent(
            ...
            {
              default: ($$result3) =>
                renderTemplate` ${renderComponent($$result3, 'Header', $$Header, {
                  links: [
                    { text: 'Inici', href: '#' },
