...
const $$LandingLayout2 = createComponent(
  ($$result, $$props, $$slots) => {
    ...
    return renderTemplate`${renderComponent(
      ...
      { metadata: metadata },
      {
        announcement: ($$result2) =>
          renderTemplate`${renderComponent($$result2, 'Fragment', Fragment, { slot: 'announcement' }, { default: ($$result3) => renderTemplate` ${renderSlot($$result3, $$slots['announcement'])} ` })}`,
        ...
        header: ($$result2) =>
          renderTemplate`${renderComponent(
            ...
            {
              default: ($$result3) =>
                renderTemplate` ${renderSlot(
                  $$result3,
                  $$slots['header'],
                  renderTemplate` ${renderComponent($$result3, 'Header', $$Header, {
                    links: headerData?.links[0] ? [headerData.links[0]] : void 0,
                    actions: [
                      {
