...
const $$CalendarioMesaTriangular = createComponent(
  ($$result, $$props, $$slots) => {
    const galleryImages = [
    ...
    const metadata = {
      ...
      description:
        'Imprime calendarios de mesa personalizados y plegados en Barcelona. Calendarios con fotos personalizados para empresas. Perfectos para promocionar tu negocio.',
      keywords: [
      ...
      jsonLd: {
        ...
        description:
          'Solicita calendarios de mesa personalizados plegados con fotos y logotipos. Ideal para promocionar tu marca en Barcelona y Catalu\xF1a todo el a\xF1o.',
        ...
        keywords:
          'calendarios personalizados empresas, calendarios plegados Barcelona, calendarios de mesa triangular, imprenta en Barcelona, calendarios con fotos personalizados',
      },
    };
      ...
      { metadata: metadata },
      {
        default: ($$result2) =>
          renderTemplate`  ${renderComponent($$result2, 'Hero2', $$Hero2, {
            tagline: 'Calendarios de Mesa Personalizados',
            title: 'Impresi\xF3n de Calendarios de Mesa en Barcelona | Dise\xF1o Triangular y Plegado',
            subtitle:
              'Imprime calendarios de mesa personalizados y plegados en Barcelona. Perfectos para la promoci\xF3n de tu empresa durante todo el a\xF1o.',
            actions: [
              {
                variant: 'primary',
                text: 'Solicita tu oferta',
                href: '#form-section',
            ...
            id: 'features',
            tagline: 'Beneficios de los Calendarios Personalizados',
            title: '6 Ventajas de Imprimir Calendarios de Mesa Triangulares y Plegados en Barcelona',
            subtitle:
              'Conoce las ventajas de nuestros calendarios personalizados con fotos y logotipos para la promoci\xF3n empresarial en Barcelona.',
            items: [
              {
                title: 'Promoci\xF3n continua',
                description:
                  'Los calendarios de mesa personalizados aseguran visibilidad diaria de tu marca durante todo el a\xF1o. Ideales para promocionar empresas en Barcelona.',
                icon: 'tabler:calendar-check',
              },
              {
                title: 'Dise\xF1o plegado y compacto\u200B',
                description:
                  'Calendarios de mesa plegados y triangulares, f\xE1ciles de colocar en cualquier escritorio, perfectos para ahorrar espacio.',
                icon: 'tabler:desk',
              },
              {
                title: 'Personalizaci\xF3n con fotos y logotipos',
                description:
                  'Nuestros calendarios permiten personalizar con tus fotos y logotipos, asegurando que tu marca destaque.',
                icon: 'tabler:calendar-heart',
              },
              {
                title: 'Impresi\xF3n econ\xF3mica en Barcelona',
                description:
                  'Imprime calendarios plegados y triangulares a precios competitivos en nuestra imprenta en Barcelona.',
                icon: 'tabler:calendar-dollar',
              },
              {
                title: 'Funcionalidad y estilo',
                description:
                  'Calendarios de mesa que combinan estilo y funcionalidad, permitiendo un f\xE1cil acceso a las fechas importantes durante el a\xF1o.',
                icon: 'tabler:calendar-smile',
              },
              {
                title: 'Materiales duraderos',
                description:
                  'Fabricados con materiales de alta calidad, nuestros calendarios plegados aseguran durabilidad durante todo el a\xF1o.',
                icon: 'tabler:hammer',
              },
            ],
