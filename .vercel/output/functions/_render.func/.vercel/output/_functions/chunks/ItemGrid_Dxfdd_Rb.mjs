...
const $$ItemGrid = createComponent(
  ($$result, $$props, $$slots) => {
    ...
    return renderTemplate`${
      items &&
      renderTemplate`${maybeRenderHead()}<div${addAttribute(
        twMerge(
