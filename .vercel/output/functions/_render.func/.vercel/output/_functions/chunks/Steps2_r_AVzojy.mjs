...
const $$Steps2 = createComponent(
  async ($$result, $$props, $$slots) => {
    ...
    return renderTemplate`${renderComponent(
      ...
      {
        default: ($$result2) =>
          renderTemplate` ${maybeRenderHead()}<div${addAttribute(`flex flex-col gap-8 md:gap-12 md:flex-row ${isReversed ? 'md:flex-row-reverse' : ''}`, 'class')}> <div${addAttribute(`w-full lg:w-1/2 gap-8 md:gap-12 ${isReversed ? 'lg:ml-16 md:ml-8 ml-0' : 'lg:mr-16 md:mr-8 mr-0'}`, 'class')}> ${renderComponent(
            $$result2,
            'Headline',
            $$Headline,
            {
  ...
  'C:/Users/Jordi/Documents/web/calendaris/src/components/widgets/Steps2.astro',
  void 0
);
