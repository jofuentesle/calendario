...
const $$MobileApp = createComponent(
  ($$result, $$props, $$slots) => {
...
`,
              ...
              title: ($$result3) =>
                renderTemplate`${renderComponent($$result3, 'Fragment', Fragment, { slot: 'title' }, { default: ($$result4) => renderTemplate` <span class="text-accent dark:text-white highlight">AstroWind App</span>: <br> professional websites <span class="hidden xl:inline">made easy</span> ` })}`,
            }
            ...
            {
              content: ($$result3) =>
                renderTemplate`${renderComponent($$result3, 'Fragment', Fragment, { slot: 'content' }, { default: ($$result4) => renderTemplate` <h3 class="text-2xl font-bold tracking-tight dark:text-white sm:text-3xl mb-2">Main Features</h3> ` })}`,
            }
          )}  ${renderComponent(
            $$result2,
            'Content',
            ...
            {
              content: ($$result3) =>
                renderTemplate`${renderComponent($$result3, 'Fragment', Fragment, { slot: 'content' }, { default: ($$result4) => renderTemplate` <h3 class="text-2xl font-bold tracking-tight dark:text-white sm:text-3xl mb-2">Other features</h3> ` })}`,
            }
