            ...
            },
            {
              subtitle: ($$result3) =>
                renderTemplate`${renderComponent(
                  ...
                  { slot: 'subtitle' },
                  {
                    default: ($$result4) => renderTemplate` ${maybeRenderHead()}<span class="hidden sm:inline">
...
Simplify web design with Astrowind: <br> your ultimate <span class="text-accent dark:text-white highlight">SaaS</span> companion<br> `,
                  }
                )}`,
            }
...
Startup success stories: <br><span class="text-2xl">Launching with AstroWind</span> </h3> `,
                  }
                )}`,
            }
          )}  ${renderComponent(
...
SaaS showcase: <br><span class="text-2xl">Streamlining user experience</span> </h3> `,
                  }
                )}`,
            }
          )}  ${renderComponent(
...
Creative portfolios: <br><span class="text-2xl">Highlighting your work</span> </h3> `,
                  }
                )}`,
            }
          )}  ${renderComponent(
...
Small business growth: <br><span class="text-2xl">Converting visitors into customers</span> </h3> `,
                  }
                )}`,
            }
          ...
          )}  ${renderComponent($$result2, 'Steps2', $$Steps2, {
