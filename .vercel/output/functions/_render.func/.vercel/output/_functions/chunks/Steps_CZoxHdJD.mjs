...
const $$Timeline = createComponent(
  ...
  'C:/Users/Jordi/Documents/web/calendaris/src/components/ui/Timeline.astro',
  void 0
);
...
const $$Steps = createComponent(
  async ($$result, $$props, $$slots) => {
    ...
    return renderTemplate`${renderComponent(
      ...
      {
        default: ($$result2) =>
          renderTemplate` ${maybeRenderHead()}<div${addAttribute(['flex flex-col gap-8 md:gap-12', { 'md:flex-row-reverse': isReversed }, { 'md:flex-row': image }], 'class:list')}> <div${addAttribute(['md:py-4 md:self-center', { 'md:basis-1/2': image }, { 'w-full': !image }], 'class:list')}> ${renderComponent(
            $$result2,
            'Headline',
            $$Headline,
            {
  ...
  'C:/Users/Jordi/Documents/web/calendaris/src/components/widgets/Steps.astro',
  void 0
);
