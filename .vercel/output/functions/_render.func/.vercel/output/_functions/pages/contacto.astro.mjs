...
const $$Contacto = createComponent(
  async ($$result, $$props, $$slots) => {
    ...
    return renderTemplate`${renderComponent(
      ...
      {
        default: ($$result2) =>
          renderTemplate`  ${renderComponent($$result2, 'HeroText', $$HeroText, { tagline: 'contacto', title: 'Hola! ¿Necesitas ayuda?' })} ${renderComponent(
            $$result2,
            'ContactUs',
            $$Contact,
            {
              ...
              subtitle:
                'Estamos aquí para ayudarte a crear el calendario perfecto, desde el diseño hasta la impresión, con opciones personalizadas y soporte en cada paso.',
              inputs: [
                {
                  type: 'text',
                  name: 'name',
