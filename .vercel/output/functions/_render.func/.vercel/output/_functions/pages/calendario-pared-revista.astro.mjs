...
const $$CalendarioParedRevista = createComponent(
  ($$result, $$props, $$slots) => {
    const galleryImages = [
    ...
    const metadata = {
      ...
      jsonLd: {
        ...
        keywords:
          'Calendarios personalizados Barcelona, Calendarios tipo revista para pared 2025, Impresi\xF3n de calendarios en Barcelona, Calendarios de pared publicitarios, Compra calendarios tipo revista online, Calendarios de empresa 2025, Calendarios de pared personalizados, Calendarios de dise\xF1o para empresas, Calendarios de pared de calidad en Barcelona',
      },
    };
      ...
      { metadata: metadata },
      {
        default: ($$result2) =>
          renderTemplate`  ${renderComponent($$result2, 'Hero2', $$Hero2, {
            tagline: 'Calendario tipo revista',
            title: 'Calendarios de pared 2025 personalizados',
            subtitle: 'Impresi\xF3n de alta calidad y dise\xF1o atractivo para promocionar tu marca en Barcelona.',
            actions: [
              {
                variant: 'primary',
                text: 'Pide tu oferta!',
            ...
            id: 'features',
            tagline: 'Caracter\xEDsticas Clave',
            title: '\xBFPor qu\xE9 elegir nuestros calendarios de pared',
            subtitle: 'Impresi\xF3n de alta calidad y dise\xF1o atractivo para promocionar tu marca en Barcelona.',
            items: [
              {
                title: 'Impresi\xF3n Personalizada',
                description:
                  'Personaliza calendarios tipo revista para pared con tu logotipo y dise\xF1o \xFAnico. Ideales para promociones efectivas en Barcelona.',
                icon: 'tabler:calendar',
              },
              {
                title: 'Alta Calidad de Impresi\xF3n',
                description:
                  'Usamos tecnolog\xEDa de impresi\xF3n avanzada para asegurar que cada calendario sea visualmente atractivo y duradero.',
                icon: 'tabler:printer',
              },
              {
                title: 'Dise\xF1o Promocional',
                description:
                  'Destaca tu marca todo el a\xF1o con nuestros calendarios de pared que combinan funcionalidad y est\xE9tica.',
                icon: 'tabler:printer',
              },
              {
                title: 'Entrega r\xE1pida en toda la pen\xEDnsula',
                description:
                  'Ofrecemos tiempos de entrega r\xE1pidos para que recibas tus calendarios cuando los necesites.',
                icon: 'tabler:truck',
              },
              {
              ...
              },
              {
                ...
                description:
                  'Nuestros calendarios con espiral son f\xE1ciles de colgar, adapt\xE1ndose a cualquier espacio de trabajo.',
                icon: 'tabler:wall',
              },
            ],
          })}  ${renderComponent($$result2, 'CallToAction', $$CallToAction, {
            title: 'Solicita tu Presupuesto para Calendarios Personalizados',
            subtitle:
              'Compra calendarios tipo revista para pared y recibe la mejor oferta. Impresi\xF3n r\xE1pida y entrega en toda Barcelona.',
            actions: [
              {
                variant: 'primary',
