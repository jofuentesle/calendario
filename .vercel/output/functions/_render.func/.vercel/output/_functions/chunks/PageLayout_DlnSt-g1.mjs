...
const $$Button = createComponent(
  ...
  'C:/Users/Jordi/Documents/web/calendaris/src/components/ui/Button.astro',
  void 0
);

const $$Astro$3 = createAstro('https://astrowind.vercel.app');
const $$ToggleMenu = createComponent(
  ($$result, $$props, $$slots) => {
  ...
  'C:/Users/Jordi/Documents/web/calendaris/src/components/common/ToggleMenu.astro',
  void 0
);
...
const $$Header = createComponent(
  ($$result, $$props, $$slots) => {
    ...
    return renderTemplate`${maybeRenderHead()}<header${addAttribute(
      ...
      'class:list'
    )}${spreadAttributes(isSticky ? { 'data-aw-sticky-header': true } : {})}${spreadAttributes(id ? { id } : {})} data-astro-cid-4wsjtibl> <div class="absolute inset-0" data-astro-cid-4wsjtibl></div> <div${addAttribute(
      [
        ...
        renderTemplate`<li${addAttribute(links2?.length ? 'dropdown' : '', 'class')} data-astro-cid-4wsjtibl> ${
          links2?.length
            ...
            : renderTemplate`<a${addAttribute(
                ...
                'class:list'
              )}${addAttribute(href, 'href')} data-astro-cid-4wsjtibl> ${text} </a>`
        } </li>`
    )} </ul> </nav> <div${addAttribute(
      [
        { 'ml-auto rtl:ml-0 rtl:mr-auto': position === 'left' },
        'hidden md:self-center md:flex items-center md:mb-0 fixed w-full md:w-auto md:static justify-end left-0 rtl:left-auto rtl:right-0 bottom-0 p-3 md:p-0 md:justify-self-end',
      ],
      'class:list'
    )} data-astro-cid-4wsjtibl> <div class="items-center flex justify-between w-full md:w-auto" data-astro-cid-4wsjtibl> <div class="flex" data-astro-cid-4wsjtibl> ${showToggleTheme && renderTemplate`${renderComponent($$result, 'ToggleTheme', $$ToggleTheme, { iconClass: 'w-6 h-6 md:w-5 md:h-5 md:inline-block', 'data-astro-cid-4wsjtibl': true })}`} </div> ${actions?.length ? renderTemplate`<span class="ml-4 rtl:ml-0 rtl:mr-4" data-astro-cid-4wsjtibl> ${actions.map((btnProps) => renderTemplate`${renderComponent($$result, 'Button', $$Button, { ...btnProps, class: 'btn-secondary w-full sm:mb-0', 'data-astro-cid-4wsjtibl': true })}`)} </span>` : ''} </div> </div> </div> </header> `;
  },
  'C:/Users/Jordi/Documents/web/calendaris/src/components/widgets/Header.astro',
  void 0
);
...
const $$Footer = createComponent(
  ($$result, $$props, $$slots) => {
    ...
    return renderTemplate`${maybeRenderHead()}<footer${addAttribute(
      [{ dark: theme === 'dark' }, 'relative border-t border-gray-200 dark:border-slate-800 not-prose'],
      'class:list'
...
Juan de Mena 19, 08035
  ...
  'C:/Users/Jordi/Documents/web/calendaris/src/components/widgets/Footer.astro',
  void 0
);

const $$Announcement = createComponent(
  ($$result, $$props, $$slots) => {
...
932 749 890
  ...
  'C:/Users/Jordi/Documents/web/calendaris/src/components/widgets/Announcement.astro',
  void 0
);

const IconSvg = new Proxy(
  { src: '/_astro/IconRepro.DQ6CSvNj.svg', width: 75, height: 75, format: 'svg' },
  {
