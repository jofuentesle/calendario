...
const METADATA = {
  title: { default: 'AstroWind', template: '%s — AstroWind' },
  description:
  ...
  twitter: { handle: '@onwidget', site: '@onwidget', cardType: 'summary_large_image' },
};
const APP_BLOG = {
  isEnabled: true,
  postsPerPage: 6,
  ...
  relatedPostsCount: 4,
  post: { isEnabled: true, permalink: '/%slug%', robots: { index: true, follow: true } },
...
export {
  I18N as I,
  METADATA as M,
  POST_PERMALINK_PATTERN as P,
  SITE as S,
  UI as U,
  getPermalink as a,
  getBlogPermalink as b,
  cleanSlug as c,
  getAsset as d,
  getCanonical as e,
  getHomePermalink as g,
  trimSlash as t,
};
