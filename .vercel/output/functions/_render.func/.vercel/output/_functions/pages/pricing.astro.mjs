...
const $$Pricing = createComponent(
  ($$result, $$props, $$slots) => {
    ...
    return renderTemplate`${renderComponent(
      ...
      {
        default: ($$result2) =>
          renderTemplate`  ${renderComponent($$result2, 'HeroText', $$HeroText, { tagline: 'Pricing', title: 'Stellar Pricing for Every Journey', subtitle: 'Choose the perfect plan that aligns with your cosmic goals.' })}  ${renderComponent(
            $$result2,
            'Prices',
            $$Pricing$1,
            {
            ...
            items: [
              {
                ...
                description:
                  'Choose from a range of pricing plans designed to accommodate different budgets and requirements.',
                icon: 'tabler:stairs',
              },
              {
                title: 'Transparent Pricing',
                description:
                  'Clearly displayed pricing details for each plan, with no hidden costs or unexpected charges.',
              ...
              },
              {
                title: 'Upgrade Value',
                description:
                  'Upgrade to higher-tier plans to unlock more features and benefits for an enhanced experience.',
            ...
            title: 'Pricing FAQs',
            subtitle:
              "Choosing the right plan is important, and we're here to answer your questions. If you have queries about our pricing options, you're in the right place.",
            columns: 1,
            items: [
              {
  ...
  'C:/Users/Jordi/Documents/web/calendaris/src/pages/pricing.astro',
  void 0
);
