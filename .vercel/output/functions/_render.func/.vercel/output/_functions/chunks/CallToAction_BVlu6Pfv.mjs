...
const $$CallToAction = createComponent(
  async ($$result, $$props, $$slots) => {
    const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
    Astro2.self = $$CallToAction;
    const { id, isDark = false, classes = {} } = Astro2.props;
    ...
    return renderTemplate`${renderComponent(
      ...
      {
        default: ($$result2) =>
          renderTemplate` ${maybeRenderHead()}<div class="max-w-3xl mx-auto text-center p-6 rounded-md shadow-xl dark:shadow-none dark:border dark:border-slate-600"> <!-- Headline --> ${renderComponent(
            $$result2,
            'Headline',
            $$Headline,
            {
  ...
  'C:/Users/Jordi/Documents/web/calendaris/src/components/widgets/CallToAction.astro',
  void 0
);
