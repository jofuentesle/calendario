...
`,
              ...
              title: ($$result3) =>
                renderTemplate`${renderComponent(
                  ...
                  {
                    default: ($$result4) => renderTemplate`
Elevate your online presence with our ${maybeRenderHead()}<br> <span class="text-accent dark:text-white highlight"> Beautiful Website Templates</span> `,
                  }
                )}`,
            }
  ...
  'C:/Users/Jordi/Documents/web/calendaris/src/pages/about.astro',
  void 0
);
