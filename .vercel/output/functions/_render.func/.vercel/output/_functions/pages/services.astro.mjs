...
const $$Services = createComponent(
  ($$result, $$props, $$slots) => {
    ...
    return renderTemplate`${renderComponent(
      ...
      {
        default: ($$result2) =>
          renderTemplate`  ${renderComponent($$result2, 'Hero', $$Hero, {
            tagline: 'Services',
            title: 'Elevate your projects with our stunning templates',
            subtitle:
              'Explore our meticulously crafted templates tailored to various industries and purposes. From captivating presentations to functional website designs, we offer the tools you need to succeed.',
          ...
          })}  ${renderComponent($$result2, 'Features2', $$Features2, {
            ...
            {
              content: ($$result3) =>
                renderTemplate`${renderComponent($$result3, 'Fragment', Fragment, { slot: 'content' }, { default: ($$result4) => renderTemplate` ${maybeRenderHead()}<h3 class="text-2xl font-bold tracking-tight dark:text-white sm:text-3xl mb-2">Main Features</h3> ` })}`,
            }
          )}  ${renderComponent(
            $$result2,
            'Content',
            ...
            {
              content: ($$result3) =>
                renderTemplate`${renderComponent($$result3, 'Fragment', Fragment, { slot: 'content' }, { default: ($$result4) => renderTemplate` <h3 class="text-2xl font-bold tracking-tight dark:text-white sm:text-3xl mb-2">Benefits</h3> ` })}`,
            }
