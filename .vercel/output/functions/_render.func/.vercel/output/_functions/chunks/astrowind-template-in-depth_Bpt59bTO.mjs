...
const $$DListItem = createComponent(
  ...
  'C:/Users/Jordi/Documents/web/calendaris/src/components/ui/DListItem.astro',
  void 0
);
  ...
  return createVNode(Fragment, {
    children: [
      ...
      createVNode(_components.p, {
        children: [
          'It can be a somewhat daunting task trying to get a handle on ',
      ...
      createVNode(_components.p, {
        children: [
          'This page outlines and clarifies some of the techniques found in ',
          createVNode(_components.em, {
            children: 'AstroWind',
          }),
      ...
      createVNode(_components.p, {
        children: [
          ...
          ' for styling. Furthermore, ',
          createVNode(_components.em, {
            children: 'AstroWind',
          }),
          ' defines custom low level style settings which are incorporated into ',
          createVNode(_components.em, {
            children: 'TailWind',
          }),
      ...
      createVNode(_components.p, {
        children: [
          'The styling mechanism consists of the following files (all paths are prefixed with ',
      ...
      createVNode($$DListItem, {
        ...
        children: createVNode(_components.p, {
          children: [
            'This file is essentially an extension of ',
            createVNode(_components.em, {
              children: 'TailWind’s',
            }),
      ...
      createVNode($$DListItem, {
        ...
        children: createVNode(_components.p, {
          children: [
            'This layout is used for all of the pages rendered by ',
            createVNode(_components.em, {
              children: 'AstroWind',
            }),
            '. The contents of ',
      ...
      createVNode(_components.p, {
        children: [
          ...
          ' is triggered by the little ‘sunlight’ icon:',
          createVNode($$ToggleTheme, {}),
          'in the page header. It is defined in the ',
          createVNode(_components.em, {
            children: 'components/common/ToggleTheme.astro',
          }),
          ', but the event is attached and the action defined in ',
          createVNode(_components.em, {
      ...
      createVNode(_components.p, {
        children: [
          'Note that this is a client event. ',
          createVNode(_components.em, {
      ...
      createVNode(_components.p, {
        children: [
          ...
          ' are part of the component implementation, which is a common concept among many frameworks, including ',
          createVNode(_components.em, {
            children: 'Astrojs',
          }),
      ...
      createVNode(_components.p, {
        children: [
          ...
          ' render the slot content (here, the ‘default’ content, but you can also render named slots) into a variable, and then use that content in a ',
          createVNode(_components.em, {
            children: 'div',
          }),
          ' (for instance).',
      ...
      createVNode(_components.p, {
        children: [
          ...
          ' just plops the content into the ',
          createVNode(_components.em, {
            children: '<slot/>',
          }),
      ...
      createVNode(_components.p, {
        children: [
          'Now, we get to the techniques used in ',
          createVNode(_components.em, {
            children: 'AstroWind',
          }),
          ', we’ll use the ',
      ...
      createVNode(_components.p, {
        children: [
          'You’ll note that the index file imports a lot of components, each one roughly analagous to a panel in the index page. Each of these components, in turn, is instantiated sequentially throughout the page. But, you’ll notice that some of them use this kind of construct (we’ll use the last section, ',
          createVNode(_components.em, {
      ...
      createVNode($$DListItem, {
        ...
        children: createVNode(_components.p, {
          children: [
            'Furthermore, these <Fragment/> elements each have a ',
            createVNode(_components.em, {
              children: 'slot=“(value)”',
            }),
            ' specifier.',
      ...
      createVNode(_components.p, {
        children: [
          'The answer lies in a paragraph in the ',
          createVNode(_components.em, {
            children: 'Astro',
          }),
        ...
        children: [
          ...
          createVNode(_components.p, {
            children: [
              ...
              ' attribute on the child element that you want to pass through to a matching slot ',
              createVNode(_components.code, {
      ...
      createVNode(_components.ol, {
        children: [
          ...
          createVNode(_components.li, {
            children: [
              'provide content to the parent component’s slot from the child by naming the slot in the child with a ',
              createVNode(_components.code, {
                children: 'slot="<slot-name>"',
              }),
              ' property assignment, where the ',
              createVNode(_components.em, {
                children: 'slot-name',
              }),
      ...
      createVNode(_components.p, {
        children: [
          ...
          ' is defined as a prop/argument, but it’s being processed as a slot. Interestingly, prop args and slots seem to be somewhat interchangeable: if the subtitle was just a string, it would simply take that assignment. The main difference is that if you render them independently, you have to call the render with an ',
          createVNode(_components.em, {
            children: 'await',
          }),
          ' modifier.',
