...
const $$Brands = createComponent(
  async ($$result, $$props, $$slots) => {
    ...
    return renderTemplate`${renderComponent(
      ...
      'WidgetWrapper',
      $$WidgetWrapper,
      { id: id, isDark: isDark, containerClass: `max-w-6xl mx-auto ${classes?.container ?? ''}`, bg: bg },
      {
        default: ($$result2) =>
          renderTemplate` ${renderComponent($$result2, 'Headline', $$Headline, { title: title, subtitle: subtitle, tagline: tagline })} ${maybeRenderHead()}<div class="flex flex-wrap justify-center gap-x-6 sm:gap-x-12 lg:gap-x-24"> ${icons && icons.map((icon) => renderTemplate`${renderComponent($$result2, 'Icon', $$Icon, { name: icon, class: 'py-3 lg:py-5 w-12 h-auto mx-auto sm:mx-0 text-gray-500' })}`)} ${
            images &&
            images.map(
              (image) =>
                image.src &&
                renderTemplate`<div class="flex justify-center col-span-1 my-2 lg:my-4 py-1 px-3 rounded-md dark:bg-gray-200"> ${renderComponent($$result2, 'Image', $$Image, { src: image.src, alt: image.alt || '', class: 'max-h-12', width: 120, height: 48, layout: 'fixed' })} </div>`
            )
          } </div> `,
      }
    )}`;
  },
  'C:/Users/Jordi/Documents/web/calendaris/src/components/widgets/Brands.astro',
  void 0
);

const $$Astro = createAstro('https://astrowind.vercel.app');
const $$Startup = createComponent(
  ($$result, $$props, $$slots) => {
              ...
              image: ($$result3) =>
                renderTemplate`${renderComponent(
                  ...
                  { slot: 'image' },
                  {
                    default: (
                      $$result4
                    ) => renderTemplate` ${renderComponent($$result4, 'YouTube', $$YouTube, { id: 'gxBkghlglTg', title: 'Astro just Launched.... Could it be the ultimate web framework?' })} <style>
        lite-youtube {
          margin: 0 auto;
          max-width: 100%;
        }
...
`,
          ...
          )}  ${renderComponent($$result2, 'Features3', $$Features3, {
...
`,
              ...
              title: ($$result3) =>
                renderTemplate`${renderComponent($$result3, 'Fragment', Fragment, { slot: 'title' }, { default: ($$result4) => renderTemplate`Be a part of our vision` })}`,
            }
          )} `,
      }
    )}`;
