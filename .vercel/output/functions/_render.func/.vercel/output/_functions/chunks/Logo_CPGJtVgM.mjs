...
const logo = new Proxy(
  { src: '/_astro/reprodisseny.DiMFbhQh.png', width: 391, height: 72, format: 'png' },
  {
...
const logoB = new Proxy(
  { src: '/_astro/ReprodissenyLogoB.DN_ZsufY.png', width: 391, height: 72, format: 'png' },
  {
    get(target, name, receiver) {
      if (name === 'clone') {
        return structuredClone(target);
...
const $$Logo = createComponent(
  ...
  'C:/Users/Jordi/Documents/web/calendaris/src/components/Logo.astro',
  void 0
);
