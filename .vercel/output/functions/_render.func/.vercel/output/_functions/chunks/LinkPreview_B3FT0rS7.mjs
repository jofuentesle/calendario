...
const $$Tweet = createComponent(
  ...
  'C:/Users/Jordi/Documents/web/calendaris/node_modules/@astro-community/astro-embed-twitter/Tweet.astro',
  void 0
);
...
const $$YouTube = createComponent(
  ($$result, $$props, $$slots) => {
    const Astro2 = $$result.createAstro($$Astro$2, $$props, $$slots);
    Astro2.self = $$YouTube;
    const { id, poster, posterQuality = 'default', title, ...attrs } = Astro2.props;
  ...
  'C:/Users/Jordi/Documents/web/calendaris/node_modules/@astro-community/astro-embed-youtube/YouTube.astro',
  void 0
);
...
const safeGetDOM = makeSafeGetter(async (res) => parseHTML(await res.text()).document);
function makeSafeGetter(handleResponse, { cacheSize = 1e3 } = {}) {
  ...
  return async function safeGet2(url) {
    try {
      ...
      if (!response.ok)
        throw new Error(formatError(`Failed to fetch ${url}`, `Error ${response.status}: ${response.statusText}`));
...
const $$Vimeo = createComponent(
  async ($$result, $$props, $$slots) => {
    const Astro2 = $$result.createAstro($$Astro$1, $$props, $$slots);
    Astro2.self = $$Vimeo;
    const { id, poster, posterQuality = 'default', params = '', playlabel = 'Play', style, ...attrs } = Astro2.props;
    const idRegExp = /^\d+$/;
    function extractID(idOrUrl) {
      if (idRegExp.test(idOrUrl)) return idOrUrl;
  ...
  'C:/Users/Jordi/Documents/web/calendaris/node_modules/@astro-community/astro-embed-vimeo/Vimeo.astro',
  void 0
);
...
async function parseOpenGraph(pageUrl) {
  ...
  const url =
    urlOrNull(getMetaProperty('og:url') || html.querySelector("link[rel='canonical']")?.getAttribute('href')) ||
    pageUrl;
  return { title, description, image, imageAlt, url, video, videoType };
}

const $$Astro = createAstro('https://astrowind.vercel.app');
const $$LinkPreview = createComponent(
  async ($$result, $$props, $$slots) => {
    ...
    return renderTemplate`${
      meta && meta.title
        ? renderTemplate`${maybeRenderHead()}<article${addAttribute(
            [
              'link-preview',
              {
            ...
            'class:list'
          )} data-astro-cid-ztfdmrby><div class="link-preview__content" data-astro-cid-ztfdmrby><header data-astro-cid-ztfdmrby><a class="link-preview__title"${addAttribute(id, 'href')} data-astro-cid-ztfdmrby>${meta.title}</a>${' '}${domain && renderTemplate`<small class="link-preview__domain" data-astro-cid-ztfdmrby>${domain}</small>`}</header><small class="link-preview__description" data-astro-cid-ztfdmrby>${meta.description}</small></div>${hideMedia ? null : meta.video && meta.videoType ? renderTemplate`<video controls preload="metadata" width="1200" height="630" data-astro-cid-ztfdmrby><source${addAttribute(meta.video, 'src')}${addAttribute(meta.videoType, 'type')} data-astro-cid-ztfdmrby></video>` : meta.image ? renderTemplate`<img${addAttribute(meta.image, 'src')}${addAttribute(meta.imageAlt || '', 'alt')} width="1200" height="630" data-astro-cid-ztfdmrby>` : null}</article>`
        : renderTemplate`<div class="link-preview link-preview--no-metadata" data-astro-cid-ztfdmrby><a${addAttribute(id, 'href')} data-astro-cid-ztfdmrby>${id}</a></div>`
    }`;
  },
  'C:/Users/Jordi/Documents/web/calendaris/node_modules/@astro-community/astro-embed-link-preview/LinkPreview.astro',
  void 0
);
